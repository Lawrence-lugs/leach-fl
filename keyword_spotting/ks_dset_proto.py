...
# Transferred from tiny/benchmark/keyword_spotting/keras_model
...
def get_training_data(Flags, get_waves=False, val_cal_subset=False):
  ...
  #print(f'Input Shape: {model_settings["spectrogram_length"],model_settings["dct_coefficient_count"],1}')
